                    ...
                    <div class="annual">
                        <div class="annual-top flex">
                            <div class="atop01 flex al-it-ce">
                                ...
                                <div class="name"><h3>${loginEmp.name }&nbsp;${loginEmp.rank }</h3><span>${loginEmp.dept }팀</span></div>
                            </div>
                            ...
                            <div class="atop03 flex al-it-ce">
                                <ul class="flex">
                                    <li>
                                        <em>총 연차</em>
                                        <span id="totalAnnual"><fmt:formatDate value="${loginEmp.encpn }" pattern="yyyy-MM-dd"/></span>
                                     </li>
